...
public class Program1_Concepts_ExceptionHandling {
    ...
    System.out.println(5/0);// Here the exception occurs. ArithmeticException.So next lines of code will not be printed.
