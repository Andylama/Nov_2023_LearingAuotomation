...
public class ClassAssignment_Utilclass_Register {
	...
	public void verifyRegisterWithMandatoryFields()    {
        ...
        driver.findElement(By.cssSelector("input#input-telephone")).sendKeys("987-654-3210");
	...
	public void verifyRegisterWithAllFields()   {
        ...
        driver.findElement(By.cssSelector(" fieldset#account+fieldset+fieldset>div>div>label:nth-child(2)>input")).click();
       	driver.findElement(By.cssSelector("input[name=agree] ")).click();
    	driver.findElement(By.cssSelector("input.btn.btn-primary ")).click(); 	
    	String actualAccountSucessMessage =driver.findElement(By.xpath("//div[@id ='content']/child::p[1]")).getText();
		String expectedlAccountSucessMessage = "Congratulations! Your new account has been successfully created!";
	...
	@Test(priority=3)
		...
		String expectedlAccountSucessMessage = "Warning: E-Mail Address is already registered!";
		Assert.assertTrue(actualDuplicateEmailWarning.contains(expectedlAccountSucessMessage),"Then my assertion is incorrect");
